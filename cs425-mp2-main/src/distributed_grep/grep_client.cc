...
int main() {
    ...
    if (command == "grep") {
        ...
        if (allOptions == "all" || allOptions == "1") {
            if (!test(recs, retVals, "-c \"Generated Random Number\" test*", true, "src/distributed_grep/expected_results/test1_expected.txt")) {
        ...
        if (allOptions == "all" || allOptions == "2") {
            if (!test(recs, retVals, "-Ec \"[[A-Za-z]*]\" test*", true, "src/distributed_grep/expected_results/test2_expected.txt")) {
        ...
        if (allOptions == "all" || allOptions == "3") {
            if (!test(recs, retVals, "-Ec \"WARNING|ERROR\" test*", true, "src/distributed_grep/expected_results/test3_expected.txt")) {
        ...
        if (allOptions == "all" || allOptions == "4") {
            if (!test(recs, retVals, "-Ec \"[[:alpha:]]{10,12}\" test*", true, "src/distributed_grep/expected_results/test4_expected.txt")) {
        ...
        if (allOptions == "all" || allOptions == "5") {
            if (!test(recs, retVals, "-Ec \"^[A-Z].*[.,]$\" test*", true, "src/distributed_grep/expected_results/test5_expected.txt")) {
        ...
        if (allOptions == "all" || allOptions == "6") {
            if (!test(recs, retVals, "Raspberry test*", false, "src/distributed_grep/expected_results/test6_expected.txt")) {
